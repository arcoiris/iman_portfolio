...
ActiveRecord::Schema.define(version: 20140412212132) do
  ...
  add_index "cms_blocks", ["page_content_id", "identifier"], name: "index_cms_blocks_on_page_content_id_and_identifier", using: :btree
  ...
  create_table "cms_page_contents", force: true do |t|
    t.string  "label"
    t.integer "page_id"
    t.string  "slug"
    t.text    "content"
  ...
  add_index "cms_page_contents", ["full_path"], name: "index_cms_page_contents_on_full_path", using: :btree
  ...
  add_index "cms_pages", ["site_id"], name: "index_cms_pages_on_site_id", using: :btree
  ...
  create_table "cms_variations", force: true do |t|
    t.string  "identifier"
